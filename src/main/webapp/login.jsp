...
<head>
    ...
    <link rel="stylesheet" href="<%=path%>/lib/layui-v2.6.3/css/layui.css" media="all">
    <!--[if lt IE 9]>
...
<%--                </div>--%>
                <div class="layui-form-item">
                    <input type="submit" class="layui-btn layui-btn layui-btn-normal layui-btn-fluid" value="登录"></input>
                </div>
                <a href="./register.jsp" class="forget-password">没有账号？点击立即注册</a>
            </form>
        </div>
    </div>
</div>
...
<script>
    document.getElementById("captchaPic").onclick = function () {
        // 获取img元素

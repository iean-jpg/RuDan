...
public interface userDao {
    ...
    //更新用户
    int updateUser(Connection connection, String username, String password, String rname, String email, String company, String tel, String fax, int userId) throws SQLException;
    //删除用户
